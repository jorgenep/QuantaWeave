"""Train the standalone QuantaWeave sparse MoE on JSONL text data."""
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint-dir", type=Path, default=Path("artifacts/checkpoints/quantweave-moe-checkpoint"))
